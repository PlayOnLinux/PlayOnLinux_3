...
class Ok_frame(wx.Frame): #fenêtre principale
	def __init__(self, titre):
		...
		self.buttonSuivant = wx.Button(self.panelFenp, ID_NEXT, _("Yes"), (425, 250), wx.DefaultSize)
		self.buttonNon = wx.Button(self.panelFenp, ID_NON, _("No"), (330, 250), wx.DefaultSize)

		if Variables.cancel_present == "1":		
			self.buttonAnnuler = wx.Button(self.panelFenp, ID_CANCEL, Lng.cancel, (235, 250), wx.DefaultSize)
		...
		wx.EVT_BUTTON(self, ID_NON,  self.Non)
